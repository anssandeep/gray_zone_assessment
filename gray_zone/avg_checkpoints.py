...
parser.add_argument('--filter', default='*.pth', type=str, metavar='WILDCARD',
...
def main():
    ...
    try:
        torch.save({'state_dict':final_state_dict}, args.output, _use_new_zipfile_serialization=False)
    except:
        torch.save({'state_dict':final_state_dict}, args.output)
